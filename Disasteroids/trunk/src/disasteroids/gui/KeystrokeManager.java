...
public class KeystrokeManager implements KeyListener
{
	...
	{
		UNKNOWN, QUIT, TOGGLE_MUSIC, TOGGLE_SOUND, TOGGLE_FULL_SCREEN, SET_EASTER_EGG, WARP, TOGGLE_ANTIALIASING, TOGGLE_SCOREBOARD, TOGGLE_TRACKER, START_SHOOT, STOP_SHOOT, LEFT, RIGHT, FORWARDS, BACKWARDS, UN_LEFT, UN_RIGHT, UN_FORWARDS, UN_BACKWARDS, BRAKE, UN_BRAKE, BERSERK, STRAFE_RIGHT, STRAFE_LEFT, EXPLODE_ALL, ROTATE_WEAPONS, SET_WEAPON_1, SET_WEAPON_2, SET_WEAPON_3, SET_WEAPON_4, SET_WEAPON_5, SET_WEAPON_6, SET_WEAPON_7, SET_WEAPON_8, SET_WEAPON_9, PAUSE, SAVE, LOAD, BENCHMARK_FPS, TOGGLE_HELP, DEVKEY_DEBUG, DEVKEY_INFINITE_AMMO, DEVKEY_SPAWN_BONUS, DEVKEY_SHIELD, DEVKEY_SPAWN_STATION, DEVKEY_SPAWN_ALIEN, DEVKEY_SPAWN_BLACKHOLE, VOLUME_UP, VOLUME_DOWN, ROTATE_RADAR
	...
	/**
	 * Called automatically by key listener for all keys pressed, and creates an <code>Action</code> to store the relevent
	 * data.
	 * 
	 * @param e the <code>KeyEvent</code> generated by the key listener
	 * @since Classic
