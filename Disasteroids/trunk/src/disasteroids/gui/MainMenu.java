 ...
 * NOTE: The "options" screen is really hacky. It needs to be rewritten back as a modular menu (which will itself need
 * support for gaps and the blinking cursor).
