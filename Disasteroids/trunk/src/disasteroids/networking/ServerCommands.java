...
public class ServerCommands
{
	...
	public enum Message
	{
		...
		MULTI_PACKET, CONNECT_ERROR_OLDNETCODE, PONG, FULL_UPDATE,
		// ======
		// GAME
		// ======
		PAUSE, SERVER_QUITTING,
		// =================
		// PLAYER COMMANDS
		// =================
		PLAYER_JOINED, PLAYER_QUIT, PLAYER_STRAFE, PLAYER_BERSERK,
		// ======
		// MISC
		// ======
		WEAPON_UNIT_CREATED, OBJECT_UPDATE_VELOCITY, OBJECT_CREATED, OBJECT_REMOVED;
